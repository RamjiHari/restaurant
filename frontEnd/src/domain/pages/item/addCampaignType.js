        ...
        <div class="container-fluid">
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Campaign Type</a></li>
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Add Campaign Type</a></li>
                    </ol>
                </div>
            </div>
            <div class="row">
            <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Add Campaign Type</h4>
                            </div>
                            <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4 mb-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="title" class="form-control" placeholder="Enter Campaign Name" onChange={(val)=>onChange('camp_name',val.target.value)} value={state.camp_name}/>
                                                    </div>
                                                </div>
